Pod::Spec.new do |spec|
  ...
  spec.dependency 'TXIMSDK_iOS','5.1.20'
  
  spec.requires_arc = true

  spec.source = { :http => 'https://imsdk-1252463788.cos.ap-guangzhou.myqcloud.com/5.1.20/TIM_SDK_TUIKIT_iOS_latest_framework.zip'}
